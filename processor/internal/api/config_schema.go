...
var configSchema = []ConfigSection{
	...
	// ---- fallbacks ----
	{
		...
		Title: "Fallback URLs",
		Fields: []ConfigFieldDef{
			{Name: "static_map", Type: "string", Default: "https://raw.githubusercontent.com/KartulUdus/PoracleJS/images/fallback/staticMap.png", Description: "Fallback static map image when tile generation fails"},
			{Name: "img_url", Type: "string", Default: "https://raw.githubusercontent.com/KartulUdus/PoracleJS/images/fallback/mon.png", Description: "Fallback pokemon icon image"},
			{Name: "img_url_weather", Type: "string", Default: "https://raw.githubusercontent.com/KartulUdus/PoracleJS/images/fallback/weather.png", Description: "Fallback weather icon image"},
			{Name: "img_url_egg", Type: "string", Default: "https://raw.githubusercontent.com/KartulUdus/PoracleJS/images/fallback/uni.png", Description: "Fallback egg icon image"},
			{Name: "img_url_gym", Type: "string", Default: "https://raw.githubusercontent.com/KartulUdus/PoracleJS/images/fallback/gym.png", Description: "Fallback gym icon image"},
			{Name: "img_url_pokestop", Type: "string", Default: "https://raw.githubusercontent.com/KartulUdus/PoracleJS/images/fallback/pokestop.png", Description: "Fallback pokestop icon image"},
			{Name: "pokestop_url", Type: "string", Default: "https://raw.githubusercontent.com/KartulUdus/PoracleJS/images/fallback/pokestop.png", Description: "Fallback pokestop URL for the pokestop_url DTS field"},
		},
	},
