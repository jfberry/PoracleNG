...
var questSummaryFields = []FieldDef{
	...
	{Name: "rewardName", Type: "string", Description: "Translated display name for the shared reward. For type==7 with a non-zero rewardForm the form name is appended in parentheses (e.g. \"Spinda (Spinda 01)\").", Category: "quest", Preferred: true},
