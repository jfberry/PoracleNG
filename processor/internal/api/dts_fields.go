...
var questSummaryFields = []FieldDef{
	...
	{Name: "rewardName", Type: "string", Description: "Translated display name for the shared reward — matches the per-row reward strings from regular quest enrichment. Examples: \"Spinda Spinda 01\" (type 7 with form), \"Spinda Candy\" (type 4), \"Spinda Mega Energy\" (type 12), bare item name (type 2 — amount omitted because it varies per stop), \"1500 Stardust\" (type 3).", Category: "quest", Preferred: true},
